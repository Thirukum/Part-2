...
const App = () => {
    ...
    if(!isNotANewName && !isNotANewNumer){
      ...
      if(window.confirm(`${newName} is already added to phonebook, Replace the Old number with a new one?`)){
        ...
        personeService
          ...
          .catch( error =>{
            setNotificationType('error');
            setNotificationMessage(`Information of ${newName} Already Removed from serer`)
      ...
      alert(`${newName} is Already Added to Phonebook Directory` );
      setNewName('')
      setNewNumber('')
    }
  ...
  return (
    <div>
      ...
      <h2>Add a new Person name and NumberS </h2>
